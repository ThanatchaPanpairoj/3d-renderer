...
public class RendererComponent extends JComponent
{
    ...
    public RendererComponent(int width, int height) {
        ...
        shapes.add(new Cube(Color.WHITE, 200, -3400, height  / 2 - 600,  1800));
        shapes.add(new Cube(Color.WHITE, 200, -3400, height  / 2 - 600,  2200));
        shapes.add(new Cube(Color.WHITE, 200, -3400, height  / 2 - 600,  2600));
        shapes.add(new Cube(Color.WHITE, 200, -3400, height  / 2 - 600,  3000));
        shapes.add(new Cube(Color.WHITE, 200, -3400, height  / 2 - 600,  3400));
        shapes.add(new Cube(Color.WHITE, 200, -3800, height  / 2 - 600,  3400));
        shapes.add(new Cube(Color.WHITE, 200, -4200, height  / 2 - 600,  3400));
        shapes.add(new Cube(Color.WHITE, 200, -4600, height  / 2 - 600,  3400));
        shapes.add(new Cube(Color.WHITE, 200, -5000, height  / 2 - 600,  3400));
        shapes.add(new Cube(Color.WHITE, 200, -5000, height  / 2 - 600,  3000));
        shapes.add(new Cube(Color.WHITE, 200, -5000, height  / 2 - 600, 2600));
        shapes.add(new Cube(Color.WHITE, 200, -5000, height  / 2 - 600, 2200));
        shapes.add(new Cube(Color.WHITE, 200, -5000, height  / 2 - 600, 1800));
